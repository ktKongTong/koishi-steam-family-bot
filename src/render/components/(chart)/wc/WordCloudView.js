...
import {layoutItems} from "./wordCloud";
...
echarts.extendChartView({
  ...
  render: function (seriesModel, ecModel, api) {
    ...
    seriesModel.ondraw = function (text, size, dataIdx, drawn) {
      ...
      textEl.setStyle({
        x: drawn.info.fillTextOffsetX + 40,
        y: drawn.info.fillTextOffsetY + size * 0.5 + 40,
        text: text,
